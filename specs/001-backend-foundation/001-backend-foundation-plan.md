...
Paths this list got wrong or left out, and decisions amended while implementing. None
changes the scope, the steps or an acceptance criterion, so the plan stays `approved`; they
